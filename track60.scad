...
module buffer_or_ramp60(radius, surface="road-rail", part="all",
  ...
  clearance = !is_double ? 1 :
    /* needs to clear double connector */
    endswith(which, "ramp") ? -8 : -3;
